...
(function($) {
	...
	*/
	...
	$.extend(Timepicker.prototype, {
		...
		_injectTimePicker: function() {
			...
			if ($dp.find("div.ui-timepicker-div").length === 0 && o.showTimepicker) {
				var noDisplay = ' style="display:none;"',
					html = '<div class="ui-timepicker-div'+ (o.isRTL? ' ui-timepicker-rtl' : '') +'"><dl>' + '<dt class="ui_tpicker_time_label"' + ((o.showTime) ? '' : noDisplay) + '>' + o.tj�|�U  j�|�U                  �ϳ|�U          p�|�U  xj�|�U          0j�|�U   @      0j�|�U          ;
		...
		*/
		_onSelectHj�|�U  j�|�U                  �ϳ|�U          p�|�U  xj�|�U          0j�|�U   @      0j�|�U          inputEl = this.$input ? this.$input[0] : null;
			if (onSelect && inputEl) {
	...
	*/
	...
	$.datepicker._updateDatepicker = function(inst) {
		...
		// j�|�U  j�|�U                  �ϳ|�U          p�|�U  xj�|�U          0j�|�U   @      0j�|�U          if ($.datepicker._curInst && $.datepicker._curInst != inst && $.datepicker._datepickerShowing && $.datepicker._lastInput != input) {
			return;
		}
