...
<div class="contact-form-list">
    ...
    <?php if ( ! class_exists( 'WeForms_Pro' ) ) {?>
        <div>
            <h2>You're using weForms Free. For more features, modules and more consider upgrading to Pro.</h2>
            <a href="weformspro.com/pricing[utm]" target="_blank">UPGRADE NOW!</a>
        </div>
    <?php } ?>
...
<p>Adding a Privacy Policy consent checkbox is your forms is simple. All you will need is the WeForms plugin and an existing /privacy-policy page.</p>
