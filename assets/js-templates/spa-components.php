...
<div class="wrap weforms-premium about-wrap">
    ...
    <p class="about-text"><?php _e( 'Upgrade to weForms premium to unlock even more features.', 'weforms' ); ?></p>
    ...
    <div class="feature-section one-col">
        <div class="col">
            ...
            <p>weForms Pro is designed to be used with your business need. Every package is designed and curated by keeping your requirements in mind.</p>
        </div>
    </div>
    ...
    <div class="weforms-upgrade-sticky-footer">
        <p><a class="button button-primary" href="https://wedevs.com/weforms-upgrade/" target="_blank"><?php _e( 'Upgrade Now', 'weforms' ); ?></a></p>
    </div>
