...
## Project Overview
This project is a WordPress plugin designed to implement web forms.

## Coding Standards
- Follow the coding standards defined in the ./phpcs.xml.dist file.
- This is a WordPress plugin, so the coding standards must adhere to the WordPress coding standards.
- This plugin must be compatible with PHP 7.2.5 through 8.3, as defined in the readme file "readme.txt".
- This plugin must be compatible with WordPress 5.0 and up, as defined in the readme file "readme.txt".
