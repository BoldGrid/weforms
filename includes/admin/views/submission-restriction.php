...
<table class="form-table">
    ...
    <tr class="wpuf-schedule-entries">
        <th><?php _e( 'Schedule form', 'wpuf-contact-form' ); ?></th>
        <td>
            <label>
                ...
                <?php _e( 'Schedule form for a period', 'wpuf-contact-form' ); ?>
            </label>

            <p class="description">
                <?php _e( 'Schedule for a time period the form is active.', 'wpuf-contact-form' ) ?>
            </p>
        </td>
    </tr>

    <tr class="wpuf-schedule-period show-if-scheduled">
        <th>&mdash; <?php _e( 'Schedule Period', 'wpuf-contact-form' ); ?></th>
        <td>
    ...
    <tr class="wpuf-schedule-pending show-if-scheduled">
        <th>&mdash; <?php _e( 'Form Pending Message', 'wpuf-contact-form' ); ?></th>
        <td>
    ...
    <tr class="wpuf-schedule-expired show-if-scheduled">
        <th>&mdash; <?php _e( 'Form Expired Message', 'wpuf-contact-form' ); ?></th>
        <td>
