<div class="merge-tag-wrap">
    <a href="#" v-on:click.prevent="toggleFields()" class="merge-tag-link" title="<?php echo esc_attr( 'Click to toggle merge tags', 'wpuf-contact-form' ); ?>"><span class="dashicons dashicons-editor-code"></span></a>
