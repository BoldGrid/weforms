<div>
    ...
    <?php } else {
        printf(
            esc_html__( '%sMailPoet Newsletters%s plugin does not exist. Please install the plugin.', 'weforms' ),
            '<a href="https://wordpress.org/plugins/wysija-newsletters/" target="_blank">',
            '</a>'
        );
    } ?>
</div>
