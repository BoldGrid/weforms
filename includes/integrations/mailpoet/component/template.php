<div>
    ...
    <div class="wpuf-int-form-row">
        <div class="wpuf-int-field-label">
            <label for="mailpoet-list-id"><?php _e( 'List', 'default' ); ?></label>
        </div>
        <div class="wpuf-int-field">
            ...
            <span class="description"><?php _e( 'Select your mailpoet list for subscription', 'default' ); ?></span>
        </div>
    </div>
    ...
    <fieldset>
        ...
        <p class="description" style="padding: 0 0 10px 0;">
            <?php _e( 'Please map the form input fields with mailpoet required fields', 'textdomain' ); ?>
        </p>

        <div class="wpuf-int-form-row mapping-fields">
            <div class="wpuf-int-field-label">
                <label for="mailpoet-list-id"><?php _e( 'Email Address', 'default' ); ?> <span class="required">*</span></label>
            </div>
            <div class="wpuf-int-field">
        ...
        <div class="wpuf-int-form-row">
            <div class="wpuf-int-field-label">
                <label for="mailpoet-list-id"><?php _e( 'First Name', 'default' ); ?></label>
            </div>
            <div class="wpuf-int-field">
                <div class="wpuf-int-field-small">
        ...
        <div class="wpuf-int-form-row">
            <div class="wpuf-int-field-label">
                <label for="mailpoet-list-id"><?php _e( 'Last Name', 'default' ); ?></label>
            </div>
            <div class="wpuf-int-field">
                <div class="wpuf-int-field-small">
    ...
    <?php } else {
        printf( __( '%sMailPoet Newsletters%s plugin does not exists. Please install the plugin .', 'weforms-pro' ), '<a href="https://wordpress.org/plugins/wysija-newsletters/" target="_blank" >', '</a>' );
    } ?>
</div>